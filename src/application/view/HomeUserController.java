...
public class HomeUserController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		if (greetingText != null)
			greetingText.setText("Hello " + Restaurant.getInstance().getRealCustomer
					(Restaurant.getInstance().getCurrentUserId()).getFirstName() 
					+ "! Nice to see you again.");
	}
	
	//open all options according to customer authorization
